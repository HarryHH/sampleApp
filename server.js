...
/***/ function(module, exports, __webpack_require__) {
  ...
  MessageConstants.getFirstItemWithPreview = function (dataList) {
  	...
  	for (var i in dataList) {
  		...
  		//	return dataList[i];
  		//}
  		if (dataList[i].fileType == MessageConstants.MSG_FILE_TYPES.IMAGE || dataList[i].fileType == MessageConstants.MSG_FILE_TYPES.VIDEO || dataList[i].fileType == MessageConstants.MSG_FILE_TYPES.WEBSITE) {
  ...
  exports.toDownloadableClientFormatMessages = function (src, data, cb) {
    ...
    function step1(interCallback) {
      ...
      _async2['default'].each(data, function (msg, interCallback) {
        ...
        } else if (msg.sender.type == _utilsServerConstants2['default'].TypeAnonymous && msg.sender._id && (!msg.sender.username || !msg.sender.displayname || !msg.sender.picture_url)) {
...
/***/ function(module, exports) {
  ...
  var logan_en = {
    messages: {
      ...
      CONNECTING_TO_TOPIC: 'Connecting to topic ',
      ...
      CREATE_TOPIC_TIP: 'To create a private or group space, simply name yur space and invite friends or colleagues.',
...
/***/ function(module, exports, __webpack_require__) {
  ...
  function startWorker() {
    ...
    var workerfile = __dirname + '/../src/modules/file/gcs/gcs.service.worker.js';
...
/***/ function(module, exports, __webpack_require__) {
  ...
  ClientEnvironment.serversSubdomains = {
  	...
  	loganlocal: {
  		...
  		wcsServer: {
  			subdomain: 'wcstesting.onesna.com', //'wcs.onesna.com',
  			port: ''
  		}
  	},
